...
export default function RequestsPage() {
  ...
  useEffect(() => {
    ...
    fetch("/api/user", {
      ...
      .finally(() => setLoadingRequests(false)); // Stop loading
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {loadingRequests && (
        <div className="space-y-4">
          {[...Array(3)].map((_, index) => (
            <Card key={index}>
              <CardContent className="p-4 animate-pulse flex flex-col lg:flex-row justify-between">
                  ...
                  <CardContent className="p-4 flex flex-col lg:flex-row justify-between">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <Badge
                          className={`${statusInfo.bgColor} ${statusInfo.textColor} mt-2`}
                          variant="outline">
                          {statusInfo.label}
                        </Badge>
                      </div>
        ...
        <DialogContent className="max-w-lg">
          ...
          {activeRequest?.submissions.length > 0 ? (
            <div className="space-y-2 text-sm text-gray-700">
              ...
              <p>
                {new Date(
                  activeRequest.submissions[0].submittedAt
                ).toLocaleString()}
              </p>
